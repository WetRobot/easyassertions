...
report_is_Date_atom <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_Date(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_Date_matrix <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_Date(x = x, x_nm = x_nm), 
    report_is_matrix(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_Date_vector <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_Date(x = x, x_nm = x_nm), 
    report_is_vector(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_character_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_character(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_double_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_double(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_double_gtezero_atom <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_double(x = x, x_nm = x_nm), 
    report_is_gtezero(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_double_gtzero_atom <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_double(x = x, x_nm = x_nm), 
    report_is_gtzero(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_double_ltezero_atom <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_double(x = x, x_nm = x_nm), 
    report_is_ltezero(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_double_ltzero_atom <- function(x, x_nm = NULL) {
  ...
  out <- rbind(
    report_is_double(x = x, x_nm = x_nm), 
    report_is_ltzero(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_factor_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_factor(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_integer_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_integer(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_logical_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_logical(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
...
report_is_number_atom <- function(x, x_nm = NULL) {
  x_nm <- handle_x_nm_arg(x_nm)
  out <- rbind(
    report_is_number(x = x, x_nm = x_nm), 
    report_is_atom(x = x, x_nm = x_nm)
  )
  return(out)
}
